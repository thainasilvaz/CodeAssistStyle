<x-app-layout>
  <div class="h-[86vh] w-screen bg-darkfundo">
        <div class="grid grid-cols-2  w-full h-full">
        <div class="w-full h-full text-lg grid px-20 pb-16 space-y-16 justify-items-end content-center">
        <div><button class="w-96 h-16 px-12 py-2 text-branco bg-maincolor-100 rounded-xl" id="reset">Pomodoro</button></div>
        <div><button class="w-96 h-16 px-12 py-2 text-branco bg-maincolor-100 rounded-xl" id="start-5min">Pausa Curta</button></div>
        <div><button class="w-96 h-16 px-12 py-2 text-branco bg-maincolor-100 rounded-xl" id="start-15min">Pausa Longa</button></div>
